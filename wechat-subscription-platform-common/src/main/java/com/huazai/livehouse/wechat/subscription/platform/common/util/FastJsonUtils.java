...
public class FastJsonUtils {
    /**
     * json字符串转map集合 * @param jsonStr * @return
     */
    ...
    /**
     * json字符串转换成对象 * @param jsonString * @param cls * @return
     */
    ...
    /**
     * json字符串转换成List集合 * (需要实体类) * @param jsonString * @return
     */
    ...
    /**
     * json字符串转换成ArrayList集合 * (需要实体类) * @param jsonString * @return
     */
    ...
    /**
     * List集合转换成json字符串 * @param obj * @return
     */
    ...
    /**
     * json转List * (不需要实体类) * @param jsonStr * @return
     */
